...
//    private ToggleButton myAuctionButton;
    ...
    public void generalButton(){
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/JavaGui/DashBoard/dashboard.fxml"));
    ...
    public void myAuctionButton(){
        try{
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/JavaGui/DashBoard/myAuction.fxml"));
            Parent root = loader.load();
