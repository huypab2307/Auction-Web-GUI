...
public class UserManagerTest {
    ...
    public void testCreateUserBidder() {
        ...
        User user = new User("bidder_user", "password123", 1);
    ...
    public void testCreateUserSeller() {
        ...
        User user = new User("seller_user", "password456", 2);
    ...
    public void testCreateBidderPassword() {
        ...
        User user = new User("test_user", "secure_password", 5);
    ...
    public void testCreateSellerPassword() {
        ...
        User user = new User("seller_test", "seller_pass", 10);
    ...
    public void testCreateMultipleBidders() {
        ...
        User user1 = new User("bidder1", "pass1", 1);
        User user2 = new User("bidder2", "pass2", 2);
    ...
    public void testCreateMultipleSellers() {
        ...
        User user1 = new User("seller1", "pass1", 3);
        User user2 = new User("seller2", "pass2", 4);
